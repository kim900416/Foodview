...
<link href="../css/memberSign.css" rel="stylesheet">    
<style>
body {
...
<div id="logo"  style="margin:40px 0 0 40px;">
	<a href="index.jsp">
    <img src="images/logo.PNG" width="150" height="90" alt="review_logo"> 
    
    <img src="images/title.PNG" width="180" height="100" alt="review_title" style="margin:0 0 0 350px;"> 
    </a> 
</div>
<hr>
...
<div class="ct_t "><class="ct_bl" style="margin:20px 0 0 200px;">이용약관 </div>
<table width="800" border="0" cellpadding="0" cellspacing="0" class="mg_bt20" style="margin:20px 0 0 200px;">
<tbody>
<tr>
<td colspan="2"><textarea name="memo" rows="8" cols="110" class="t" 
	style="padding:10px; color:black; font-size: 12;" readonly="">서비스 이용약관

제 1 조 (목적)
이 약관은 리뷰사이트(이하 '회사')가 제공하는 서비스의 이용과 관련하여 '회사'와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
<tr><td>&nbsp;</td></tr>
	...
	<div id="ctgr_bar">
		<div class="ct_t" style="margin:20px 0 0 200px">개인정보 수집 및 이용에 대한 안내 </div>
		<div class="slc_c"></div>
	</div>
	
<table width="800" border="0" cellpadding="0" cellspacing="0" class="mg_bt20" style="margin:20px 0 180px 200px;">
	<tbody><tr>
	
	<td colspan="2">

<textarea name="memo" rows="3" cols="110" class="t" style="padding:10px;color:black;font-size:12;'" >[수집하는 개인정보의 항목]

가. 회사는 회원가입, 원활한 고객상담, 각종 서비스의 제공을 위해 
...
<span style="display:block;margin-top:10px;line-height:150%;">
※ 회원가입은 <font color="red">만 14세 이상만 가입 가능</font>합니다. 
</span>   
...
<div class="container mt-25vh">
	<div class="row">		
		...
		<a data-toggle="modal" data-target="#sign-modal" class="btn btn-block btn-success">회원가입하기</a>		 
		</div>
	</div>
</div>
<body>
<form class="form-style" action="join.do" method="post" >
		...
		<div class="modal-content modal-style">		 
			...
			<div class="modal-body pt-0 pb-0">				
					...
					<div class="form-group has-success">
						<label class="text-uppercase control-label">ID</label>
							<input class="form-control" placeholder="Enter your ID here"
					...
					<div class="form-group has-success">
						<label class="text-uppercase control-label">Again PassWord</label>
							<input class="form-control" placeholder="Enter your full name here"
					...
					<div class="form-group has-success">
						<label class="text-uppercase control-label">Name</label>
							<input class="form-control" placeholder="Enter your full name here"
								   type="text" name="name" value="${param.name}">
					</div>				
					
					
					<div class="form-group has-success">
						<label class="text-uppercase control-label">Email</label>
							<input class="form-control" placeholder="Enter your email here"
								   type="text" name="email" value="${param.email}">
					</div>
					
					
					<div class="form-group has-success">
						<label class="text-uppercase control-label">Gender</label>
							<input class="form-control" placeholder="Enter your Gender here"
								   type="text" name="sex" value="${param.sex}">
					</div>
					
					<div class="form-group has-success">
						<label class="text-uppercase control-label">Phone</label>
							<input class="form-control" placeholder="Enter your Phone Number here"
								   type="text" name="phonNum" value="${param.phonNum}">
					</div>
